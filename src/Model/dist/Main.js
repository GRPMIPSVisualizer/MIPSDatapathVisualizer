...
let addInsSet = [
    // add normal case
    "00100100000001010000000001100100",
    "00100100000001100000000100110110",
    "00000000101001100010000000100000",
    // addi normal case
    "00100000100001110000000010000000",
    // addiu normal case
    "00100100101001110000000010000000",
    // addu normal case
    "00000000111001100100000000100001" // addu $t0,$a3,$a2
];
let addOverflowSet = [
    // li $t0 1912602936
    "00111100000000010111001000000000",
    "00110100001010000000000100111000",
    // addu $9,$8,$8
...
let addiOverflowSet = [
    ...
    "00110100001010001111001001110000",
...
let LoadSet = [
    ...
    "00100100000001100000000100110110",
    // lui
    "00111100000001000000001111101000",
